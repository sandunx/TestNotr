...
<div id="bs-settings-page">
    ...
    <div>
        <nav class="nav-tab-wrapper">
            ...
            <a href="#receipt-printing" class="nav-tab <?php echo ($tab === "receipt-printing") ? "nav-tab-active" : "" ?>" data-tab="receipt-printing"><?php echo __("Receipt printing", "us-barcode-scanner"); ?></a>
