                ...
                <div colspan="2" style="padding: 0;">
                    <table>
                        ...
                        <tr class="disabled_field">
                            <td scope="row" style="text-align:left; padding: 0 10px 0 10px; width: 110px; box-sizing: border-box;">
                                <label onclick="WebbsFieldsChToggle(this, 'usbs_field_disabled_field')" data-fid="<?php echo $field["id"]; ?>">
                                    <?php echo __("Read-only", "us-barcode-scanner"); ?>
                                </label>
                            </td>
                            <td style="padding: 0 0 5px;">
                                <!-- checkbox -->
                                <?php $checked = $field["disabled_field"] == 1 ? ' checked=checked ' : ''; ?>
                                <input type="checkbox" class="usbs_field_disabled_field" <?php esc_html_e($checked, 'us-barcode-scanner'); ?> data-fid="<?php echo $field["id"]; ?>" onchange="WebbsSettingsCheckboxChange(`#bs-settings-fields-tab .disabled_field input[data-fid='<?php echo $field['id']; ?>']`, this.checked ? '1' : '0')" />
                                <input type="hidden" name="fields[<?php echo $field["id"]; ?>][disabled_field]" value="<?php echo $checked ? "1" : "0"; ?>" data-fid="<?php echo $field["id"]; ?>" />
                            </td>
                        </tr>
