...
<form id="bs-settings-css-tab" method="POST" action="<?php echo $actualLink; ?>" enctype="multipart/form-data">
    ...
    <table class="form-table">
        <tbody>
            ...
            <tr>
                <th scope="row" style="width: 240px;">
                    <?php echo __("Custom CSS for Mobile app", "us-barcode-scanner"); ?>
                </th>
                <td>
                    <?php $customCssMobile = $settings->getSettings("customCssMobile"); ?>
                    <textarea name="customCssMobile" rows="6" cols="60"><?php echo $customCssMobile ? stripslashes($customCssMobile->value) : ""; ?></textarea>
                </td>
            </tr>
