...
class MobileRouter
{
    ...
    public function includeTemplate($template = "")
    {
        ...
        if ($route === "plugin" && $params === "checker") {
            ...
            echo "<";
            esc_html_e($tn, 'us-barcode-scanner');
            echo " src='" . USBS_PLUGIN_BASE_URL . "src/features/mobile/assets/js/index.js?v=1.5.3&t=1706622081143' ";
            echo ">";
            echo "<";
            echo "/";
            esc_html_e($tn, 'us-barcode-scanner');
            ...
            echo "<";
            esc_html_e($tn, 'us-barcode-scanner');
            echo " src='" . USBS_PLUGIN_BASE_URL . "src/features/mobile/assets/js/loader.js?v=1.5.3&t=1706622081143' ";
            echo ">";
            echo "<";
            echo "/";
            esc_html_e($tn, 'us-barcode-scanner');
  ...
  $appJsPath = plugin_dir_url(__FILE__)."../../../assets/js/bundle-business-1.5.3-1706622081143.js";

  $vendorJsPath = plugin_dir_url(__FILE__)."../../../assets/js/chunk-business-1.5.3-1706622081143.js";
        ...
        $jsData = array(
            ...
            'platform' => isset($_GET["platform"]) ? sanitize_key($_GET["platform"]) :$route,
