    ...
    public function __construct($post, $get)
    {
        ...
        if (isset($post["rout"]) && $post["rout"]) {
            ...
            $keysString = array(
                ...
                "field", "requestbs", "postAutoAction", "postAutoField", "status", "autoFill", "byId", "setQty", "orderCustomPrice", "orderCustomSubPrice", "orderCustomTax",
                ...
                "coupon", "customerId", "isPay", "fieldName"
            );
            $keysArray = array(
                "filter", "customFilter", "filterExcludes", "products", "fields", "progress", "userData", "currentItems", "itemsCustomPrices", "cartItem", "extraData",
                "inputs", "data", "categories", "locations", "codes", "lines", "autoAction", "options", "items", "filterResult", "address"
            );
            $response = array();
