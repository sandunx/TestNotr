...
class Post
{
    ...
    public function find($queryRequest, $filter, $onlyById = false, $autoFill = false, $limit = null, $searchType = "", $filterExcludes = array())
    {
        ...
        $sql = $this->ownSqlBuilder($query, $filterWithoutTitle, $excludeStatuses, $excludeProductsCatalogVisibility);
    ...
    private function ownSqlBuilder($query, $filter, $excludeStatuses, $excludeProductsCatalogVisibility = '')
    {
        global $wpdb;
