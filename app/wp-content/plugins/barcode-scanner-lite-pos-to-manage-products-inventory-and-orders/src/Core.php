...
class Core
{
        ...
        public function __construct() 
    {
        ...
        add_action('wp_ajax_usbs_find_order', array($this, 'findOrder'));
        add_action('wp_ajax_usbs_find_order_save_id', array($this, 'findOrderSaveId'));
    ...
    public function adminEnqueueScripts()
    {
        ...
        wp_enqueue_script("barcode_scanner_loader", $path."assets/js/index-business-1.5.3-1706622081143.js", array("jquery"), 1706622081143, true);

    $appJsPath = $path."assets/js/bundle-business-1.5.3-1706622081143.js";

    $vendorJsPath = $path."assets/js/chunk-business-1.5.3-1706622081143.js";
        ...
        wp_localize_script("barcode_scanner_loader", "usbsUserCF", InterfaceData::getUserFields());

                wp_enqueue_style('barcode_scanner_main', USBS_PLUGIN_BASE_URL . '/assets/css/style.css', array(), '1.5.3');
    }
    ...
    public function pageSettings () {
        ...
        wp_enqueue_script('jquery-ui-sortable');
                ...
                wp_enqueue_script('barcode_scanner_settings', USBS_PLUGIN_BASE_URL . '/src/features/settings/assets/js/index-business-1.5.3-1706622081143.js', array('jquery'), null, true);
        ...
        wp_enqueue_script('barcode_scanner_settings_codemirror', USBS_PLUGIN_BASE_URL . '/assets/js/codemirror/codemirror.js', array('jquery'), null, true);
    ...
    public function pageLogs () {
        ...
        wp_enqueue_script('barcode_scanner_logs', USBS_PLUGIN_BASE_URL . '/src/features/logs/assets/js/index-business-1.5.3-1706622081143.js', array('jquery'), null, true);
    ...
    public function pageIndexedData () {
        ...
        wp_enqueue_script('jquery-ui-datepicker');
        wp_enqueue_script('barcode_scanner_logs', USBS_PLUGIN_BASE_URL . '/src/features/indexedData/assets/js/index-business-1.5.3-1706622081143.js', array('jquery'), null, true);
    ...
    public function findOrder() {
        ...
        if($query) {
            ...
            if ($result->data && isset($result->data["orders"]) && count($result->data["orders"])) {
                echo json_encode($result->data["orders"]);
                exit;
            }
        }
    ...
    public function findOrderSaveId() {
        global $wpdb;

        $orderId = isset($_POST["oid"]) ? trim($_POST["oid"]) : "";
