...
<div id="page" class="site">
  ...
  <header id="masthead" class="site-header">
    ...
    <div class="fixed-top navbar-nav-scroll">
      ...
      <nav id="nav-main" class="navbar navbar-expand-lg">
        ...
        <div class="<?= bootscore_container_class(); ?>">
          ...
          <!-- Navbar Brand -->
          <a class="navbar-brand xs d-md-none" href="<?= esc_url(home_url()); ?>"><img src="<?= esc_url(get_stylesheet_directory_uri()); ?>/img/logo/notr.svg" alt="logo" class="logo xs"></a>
          <a class="navbar-brand md d-none d-md-block" href="<?= esc_url(home_url()); ?>"><img src="<?= esc_url(get_stylesheet_directory_uri()); ?>/img/logo/notr.svg" alt="logo" class="logo md"></a>
